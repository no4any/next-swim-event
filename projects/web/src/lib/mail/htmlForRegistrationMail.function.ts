export default function htmlForRegistrationMail(link: string, name: string): string {
    ...
    <p>Mit dieser Mail erhältst du den Link zu deinen Anmeldedaten. <b>Behandeln diesen Link vertraulich!</b> Sollten Änderungen nötig sein, kannst du diese beim Check-In am Veranstaltungstag vornehmen lassen.</p>
